...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-1cc77785');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-1cc77785');}
...
var brandEl=document.querySelector('.rl-brand-1cc77785');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
